...
def internal_create_initiative(
    ...
    """Create a new initiative. Operation tracking handled by callback handler."""
    return dedent(
        f"""Initiative '{title}' will be created with temporary identifier '{temporary_identifier}'. 
        Use this identifier when creating tasks for this initiative. 
        You should always create tasks for a new initiative with the same temporary initiative identifier.
        Call the `internal_create_task` tool to create a task for this initiative.
        Tasks should break the initiative down to deliverable items that can be completed independently.
