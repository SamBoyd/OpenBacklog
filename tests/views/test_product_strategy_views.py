...
def test_update_outcome_success_all_fields(test_client, workspace, user):
...
def test_update_outcome_validation_error_empty_name(test_client, workspace, user):
    """Test validation error for empty name returns 422."""
    from src.controllers import product_strategy_controller
    from src.db import SessionLocal
...
def test_update_outcome_validation_error_name_too_long(test_client, workspace, user):
    """Test validation error for name exceeding max length returns 422."""
    from src.controllers import product_strategy_controller
    from src.db import SessionLocal
...
def test_update_outcome_validation_error_metrics_too_long(test_client, workspace, user):
    """Test validation error for metrics exceeding max length returns 422."""
    from src.controllers import product_strategy_controller
    from src.db import SessionLocal
...
def test_update_outcome_pillar_links(test_client, workspace, user):
...
def test_update_outcome_unauthorized(test_client_no_user, workspace):
...
def test_delete_outcome_success(test_client, workspace, user):
...
def test_delete_outcome_not_found(test_client, workspace):
...
def test_delete_outcome_unauthorized(test_client_no_user, workspace):
...
def test_reorder_outcomes_success(test_client, workspace, user):
...
def test_reorder_outcomes_outcome_not_found(test_client, workspace, user):
...
def test_reorder_outcomes_unauthorized(test_client_no_user, workspace):
