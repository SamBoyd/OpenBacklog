...
class TestVisionViews:
    def test_get_vision_unauthorized(self, test_client_no_user, workspace):
    ...
    def test_upsert_vision_create(self, test_client, workspace):
    ...
    def test_upsert_vision_update(self, test_client, workspace, product_vision):
    ...
    def test_upsert_vision_validation_error_empty(self, test_client, workspace):
    ...
    def test_upsert_vision_validation_error_too_long(self, test_client, workspace):
    ...
    def test_upsert_vision_workspace_not_found(self, test_client):
    ...
    def test_upsert_vision_unauthorized(self, test_client_no_user, workspace):
