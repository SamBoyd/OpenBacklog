...
const mockTheme: ThemeDto = {
    ...
    problem_statement: 'AI assistants lack native access to product context, forcing developers to manually context-switch between tools.',
    hypothesis: 'If we expose product management data through an MCP server, AI assistants can query it natively and make better decisions without breaking developer flow.',
    indicative_metrics: 'Reduction in context switches, faster feature implementation, improved AI decision quality',
...
const mockThemeMinimal: ThemeDto = {
    ...
    problem_statement: 'Teams need visibility into how consistent their product narrative is over time.',
    hypothesis: null,
